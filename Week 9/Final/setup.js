...
export function setScene() {
    ...
    minimapRenderer.domElement.className = "minimap";
    positionMinimap();
...
//Only needed because of the inset renderer
function positionMinimap() {
    const rect = renderer.domElement.getBoundingClientRect();
    minimapRenderer.domElement.style.top = rect.top + 20 + "px";
    minimapRenderer.domElement.style.left = rect.left + 20 +"px";
}
